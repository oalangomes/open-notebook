export const ptBR = {
  ...
  sources: {
    ...
    statusCanceledDesc: "Processamento cancelado antes da execução",
  ...
  advanced: {
    ...
    sourceQueue: {
      title: "Fila das Fontes",
      desc: "Acompanhe o processamento das fontes e cancele itens ainda aguardando execução.",
      activeCount: "{count} ativo(s)",
      pollingHint: "Atualização automática a cada 4s enquanto houver itens na fila ou em execução.",
      empty: "Nenhum job de fonte encontrado para este filtro.",
      loadFailed: "Falha ao carregar a fila das fontes",
      cancelTitle: "Cancelar processamento?",
      cancelDesc: "Tem certeza que deseja cancelar o processamento de \"{name}\"?",
      cancelDescGeneric: "Tem certeza que deseja cancelar este job de processamento?",
      cancelSuccess: "Job cancelado com sucesso",
