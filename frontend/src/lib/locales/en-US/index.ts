export const enUS = {
  ...
  sources: {
    ...
    statusCanceledDesc: "Processing was canceled before execution",
  ...
  advanced: {
    ...
    sourceQueue: {
      title: "Source Queue",
      desc: "Track source processing jobs and cancel items that have not started yet.",
      activeCount: "{count} active",
      pollingHint: "Auto-refreshes every 4s while queue items are pending or running.",
      empty: "No source jobs found for this filter.",
      loadFailed: "Failed to load source queue",
      cancelTitle: "Cancel processing?",
      cancelDesc: "Are you sure you want to cancel processing for \"{name}\"?",
      cancelDescGeneric: "Are you sure you want to cancel this processing job?",
